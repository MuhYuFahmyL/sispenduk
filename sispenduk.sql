...
CREATE TABLE `pengajuan` (
  `id` int(50) NOT NULL,
  `jenis_surat` enum('surat_keterangan','surat_keterangan_domisili','surat_keterangan_usaha','surat_keterangan_berkelakuan_baik','surat_pengantar_skck') DEFAULT NULL,
