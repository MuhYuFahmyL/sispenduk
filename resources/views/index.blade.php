    ...
    <section class="header">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-xl-5">
                    <h1>lebih praktis <br> dengan <span>SISPENDUK</span></h1>
                    <p>Gunakan layanan dari aplikasi SISPENDUK untuk mengajukan surat - menyurat atau melakukan pengaduan
    ...
    <section class="feature">
        <div class="container">
            <div class="row mb-5 text-center">
                <div class="col">
                    <h2>Fitur SISPENDUK</h2>
                    <p>Dengan fitur dari SISPENDUK, masyarakat dapat lebih menghemat waktu dalam mengurus berkas</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row text-center mt-3">
                <div class="col text-light">
                    <p>Copyright &copy; 2021 &mdash; SISPENDUK | All right reserved.</p>
                </div>
            </div>
        </div>
    </footer>
