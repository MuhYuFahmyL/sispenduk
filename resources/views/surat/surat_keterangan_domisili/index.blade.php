...
<body>
    <div>
        ...
        <div align="center"><u>
                <h4 class="kop">SURAT KETERANGAN DOMISILI</h4>
            </u>
        ...
        <div id="isi3">
            ...
            <table width="100%">
                <tr>
                    <td class="indentasi">Bahwa benar-benar penduduk kami Dusun <a style="text-transform: capitalize;">
                            @php echo 'V'; @endphp, Desa @__raw_block_1__@, Kecamatan @__raw_block_2__@,
                            @php echo 'Kabupaten Deli Serdang'; @endphp</a>.
                        Bahwa nama yang bersangkutan berdomisili di <a style="text-transform: capitalize;">
                            <b><u>{{ $data->user->nik->alamat }}, RT {{ $data->user->nik->rt }} /RW
                                    {{ $data->user->nik->rw }} ,
                                    Dusun {{ $data->user->nik->dusun }} , Desa {{ $data->user->nik->kelurahan }} ,
                                    Kecamatan
                                    {{ $data->user->nik->kecamatan }} ,
                                    {{ $data->user->nik->kabupaten }}</u></b></a>.</td>
                </tr>
            </table><br>
            <table width="100%">
                <tr>
        ...
        <table width="100%" style="text-transform: capitalize;">
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td align="center"><?php echo 'Kepala Desa' . ' ' . 'Tanjung Baru'; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td align="center" style="text-transform: uppercase;"><img src="assets/img/Approval.jpeg" alt=""
                        height="160" width="230"></td>
            </tr>
        </table>
    </div>
